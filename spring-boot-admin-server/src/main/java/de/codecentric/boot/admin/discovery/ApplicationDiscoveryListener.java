...
/**
 * Listener for Heartbeats events to publish all services to the application
 * registry.
 * 
 * @author Johannes Stelzer
 */
public class ApplicationDiscoveryListener implements
	...
	public void discover() {
		for (String serviceId : discoveryClient.getServices()) {
			for (ServiceInstance instance : discoveryClient
	...
	private Application convert(ServiceInstance instance) {
		String serviceUrl = append(instance.getUri().toString(),
				serviceContextPath);
		String managementUrl = append(instance.getUri().toString(),
