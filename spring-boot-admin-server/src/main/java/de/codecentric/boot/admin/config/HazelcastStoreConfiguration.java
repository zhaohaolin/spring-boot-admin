...
public class HazelcastStoreConfiguration {
	...
	public ApplicationStore applicationStore(HazelcastInstance hazelcast) {
		IMap<String, Application> map = hazelcast
				.<String, Application> getMap(hazelcastMapName);
	...
	private static class ApplicationEntryListener implements
			EntryListener<String, Application> {
		@Autowired
