...
@Configuration
@Import({ RevereseZuulProxyConfiguration.class,
		MailNotifierConfiguration.class, HazelcastStoreConfiguration.class,
		SimpleStoreConfig.class, DiscoveryClientConfiguration.class })
public class AdminServerWebConfiguration extends WebMvcConfigurerAdapter
	 ...
	 * @return Controller with REST-API for spring-boot applications to register
	 *         itself.
	 */
	@Bean
